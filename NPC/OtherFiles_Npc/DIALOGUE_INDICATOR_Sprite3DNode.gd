...
signal turn_CHAR_towards_Npc_SIGNAL
signal makeCamCurrent_NPC_signal
signal turn_NPC_towards_Char_SIGNAL
...
#		camera_CHAR.set_current(true)
		...
		npc_position.y = 0
		emit_signal("turn_CHAR_towards_Npc_SIGNAL", npc_position)
...
#		camera_THIS_NPC.set_current(true)
		...
		emit_signal("turn_NPC_towards_Char_SIGNAL")
